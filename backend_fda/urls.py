"""
URL configuration for backend_fda project.
...
from orders.api.views import (TableListAPIView, TableDetailAPIView, OrderListAPIView, OrderDetailAPIView, OrderItemListAPIView, OrderItemDetailAPIView, ApiHomepage)
